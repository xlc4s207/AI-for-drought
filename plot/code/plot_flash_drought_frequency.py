...
def plot_spatial_distribution(data1, bounds1, data2, bounds2, output_path):
    ...
    # 设置标题和标签
    ax1.set_title('SMrz Flash Drought Frequency (1980-2024)', fontsize=14, fontweight='bold')
    ...
    # 设置标题和标签
    ax2.set_title('SMs Flash Drought Frequency (1980-2024)', fontsize=14, fontweight='bold')
...
def main():
    ...
    output_file = os.path.join(output_dir, 'flash_drought_frequency_comparison_1980_2024.jpg')
