...
# -*- coding: utf-8 -*-
"""
绘制不同季节的SMrz和SMs GPP最小值空间分布图（带海岸线）
"""
...
def main():
    ...
    # 输出目录
    output_dir = '/home/xulc/flash_drought/process/plot/jpg/seasonal_gpp_min'
    os.makedirs(output_dir, exist_ok=True)
    
    print("="*80)
    print("季节性GPP最小值空间分布图绘制（带海岸线）")
    print("="*80)
    ...
    for season in seasons:
        # 构建文件路径
        smrz_file = os.path.join(smrz_dir, f'SMrz_GPP_{season}_gpp_min.tif')
        sms_file = os.path.join(sms_dir, f'{season}_gpp_min.tif')
        ...
        # 输出文件名
        output_file = os.path.join(output_dir, f'{season}_gpp_min_comparison.jpg')
