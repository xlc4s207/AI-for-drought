"""
根系土壤湿度 (SMrz) 骤旱对GPP影响分析 - v10 全球版 (内存优化)
==========================================
基于 SMs v10 修改，使用 SMrz 骤旱事件，观测期延长到180天

主要修改：
  - 输入: flash_drought_events_v5.nc (SMrz)
  - WINDOW_AFTER: 120天 → 180天
  - 输出: code1/results/
...
TEMP_DIR = os.path.join(OUTPUT_DIR, "temp_chunks_SMrz")
...
def main():
    print("="*70)
    print("根系土壤湿度 (SMrz) 骤旱对GPP影响分析 - v10 全球版")
    print("="*70)
    print("数据源:")
