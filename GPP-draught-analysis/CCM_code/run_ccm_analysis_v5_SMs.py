"""
Lagged CCM Analysis V5 - Daily Precision with Coarse-to-Fine Search (SMs)
==========================================================================
...
DROUGHT_EVENTS_FILE = os.path.join(BASE_DIR, "gleam/result/SMs_result/flash_drought_events_details_v2.nc")
GPP_FILE = "/data/BESS_V2/BESS_GPP_1982_2022.nc"
SM_FILE = "/data/GLEAM/SMs_45years.nc"

OUTPUT_DIR = os.path.join(BASE_DIR, "process/GPP-draught-analysis/CCM_code/results_v5_SMs")
...
def main():
    print("="*70)
    print("Lagged CCM V5 - Daily Precision with Coarse-to-Fine Search (SMs)")
    print("="*70)
    ...
    print("\n保存最终结果...")
    out_file = os.path.join(OUTPUT_DIR, "ccm_lag_results_v5_SMs.nc")
    ...
    with nc.Dataset(out_file, 'w') as ds:
        ...
        ds.title = 'Lagged CCM V5: SMs -> GPP (Daily Precision)'
