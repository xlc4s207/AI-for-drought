"""
Lagged CCM Analysis V4 - 极限优化版 (内存安全 + 高速) - SMrz 版本
================================================================
核心优化策略:
...
SM_FILE = "/data/GLEAM/SMrz_45years.nc"  # SMrz 数据
...
def main():
    print("="*70)
    print("Lagged CCM V4 - 极限优化版 (SMrz 根系层土壤湿度)")
    print("="*70)
    print("内存优化策略:")
    ...
    with nc.Dataset(out_file, 'w') as ds:
        ...
        ds.title = 'Lagged CCM V4: SMrz -> GPP (Ultra Optimized)'
