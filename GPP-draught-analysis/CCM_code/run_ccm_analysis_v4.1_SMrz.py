"""
Lagged CCM Analysis V4.1 - 断点续传版 (SMrz)
=============================================
基于 V4 版本，增加断点续传功能：
- 自动检测已完成的行
- 只处理未完成的行
...
OUTPUT_DIR = os.path.join(BASE_DIR, "process/GPP-draught-analysis/CCM_code/results_v4_SMrz")
...
def main():
    print("="*70)
    print("Lagged CCM V4.1 - 断点续传版 (SMrz 根系层土壤湿度)")
    print("="*70)
    ...
    print("\n保存最终结果...")
    out_file = os.path.join(OUTPUT_DIR, "ccm_lag_results_v4_SMrz.nc")
    ...
    with nc.Dataset(out_file, 'w') as ds:
        ...
        ds.title = 'Lagged CCM V4.1: SMrz -> GPP (Checkpoint Resume)'
        ds.method = 'CCM with Numba JIT + Single-Row Processing + Checkpoint'
