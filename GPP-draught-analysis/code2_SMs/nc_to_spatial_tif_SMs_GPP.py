...
# -*- coding: utf-8 -*-
"""
将SMs骤旱GPP响应NC文件转换为空间分布TIF文件
数据源: gpp_response_SMs_events_global_v10.nc
"""
import numpy as np
import pandas as pd
...
OUTPUT_DIR = '/home/xulc/flash_drought/process/GPP-draught-analysis/code2_SMs/results/spatial_tif'
TARGET_VARS = ['gpp_min', 'gpp_trend', 't_min', 't_response', 't_impact', 't_recover', 'recovery_rate']
