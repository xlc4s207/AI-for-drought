"""
表层土壤湿度 (SMs) 骤旱对GPP影响分析 - v10 全球版 (内存优化)
==========================================
基于 SMrz v10 修改，使用 SMs 骤旱事件
...
def main():
    print("="*70)
    print("表层土壤湿度 (SMs) 骤旱对GPP影响分析 - v10 全球版")
    print("="*70)
    print("数据源:")
    ...
    print("\n保存最终结果...")
    out_file = os.path.join(OUTPUT_DIR, "gpp_response_SMs_events_global_v10.nc")
    ...
    with nc.Dataset(out_file, 'w') as ds:
        ...
        ds.title = 'GPP Response to SMs Flash Drought - Global (v10)'
