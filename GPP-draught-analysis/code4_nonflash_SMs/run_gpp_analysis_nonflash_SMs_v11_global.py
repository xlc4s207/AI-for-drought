...
# -*- coding: utf-8 -*-
"""
GPP Response Analysis - Non-Flash Drought (SMs) V11 Global
=============================================================
分析表层土壤湿度 (SMs) 非骤旱干旱事件对 GPP 的影响
...
TEMP_DIR = os.path.join(OUTPUT_DIR, "temp_chunks_nonflash_SMs")
...
def main():
    ...
    # 保存 NetCDF
    print("\n保存最终结果...")
    out_file = os.path.join(OUTPUT_DIR, "gpp_response_nonflash_SMs_drought_v11_global.nc")
...
def save_to_netcdf(results, output_file):
    ...
    with nc.Dataset(output_file, 'w', format='NETCDF4') as ds:
        ...
        # 全局属性
        ds.title = 'GPP Response to Non-Flash SMs Drought - Global Analysis (v11)'
