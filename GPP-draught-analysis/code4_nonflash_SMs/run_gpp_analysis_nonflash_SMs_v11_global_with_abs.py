...
# -*- coding: utf-8 -*-
"""
GPP Response Analysis - Non-Flash Drought (SMs) V11 Global With Absolute Metrics
==============================================================================
...
OUTPUT_DIR = os.path.join(BASE_DIR, "process/GPP-draught-analysis/code4_nonflash_SMs/result")
TEMP_DIR = os.path.join(OUTPUT_DIR, "temp_chunks_nonflash_SMs_with_abs")
...
def save_to_netcdf(final_results, out_file):
    with nc.Dataset(out_file, 'w', format='NETCDF4') as ds:
        ...
        ds.title = 'GPP Response to Non-Flash SMs Drought - Global Analysis (v11, relative + absolute metrics)'
...
def main():
    print('=' * 70)
    print('GPP Response to Non-Flash Drought (SMs) - V11 Global (relative + absolute metrics)')
    print('=' * 70)
    ...
    out_file = os.path.join(OUTPUT_DIR, 'gpp_response_nonflash_SMs_drought_v11_global_with_abs.nc')
