...
TEMP_DIR = os.path.join(OUTPUT_DIR, "temp_chunks_nonflash_SMrz_nee")
...
def process_chunk(chunk_info):
    ...
    try:
        ...
        # 读取 NEE 数据块 (NEE是int16类型，需要先转float32再填充nan)
...
def main():
    print("=" * 70)
    print("NEE Response to Non-Flash Drought (SMrz) - V11 Global")
    print("=" * 70)
    ...
    # 保存 NetCDF
    print("\n保存最终结果...")
    out_file = os.path.join(OUTPUT_DIR, "nee_response_nonflash_SMrz_drought_v11_global.nc")
...
def save_to_netcdf(results, output_file):
    ...
    with nc.Dataset(output_file, 'w', format='NETCDF4') as ds:
        ...
        # 全局属性
        ds.title = 'NEE Response to Non-Flash SMrz Drought - Global Analysis (v11)'
