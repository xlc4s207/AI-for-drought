...
TEMP_DIR = os.path.join(OUTPUT_DIR, "temp_chunks_nonflash_SMs_nee_memopt")
...
LAT_CHUNK_SIZE = 2
LON_BATCH_SIZE = 256
OUTPUT_FILENAME = "nee_response_nonflash_SMs_drought_v11_global_memopt.nc"
...
def main():
    print("=" * 70)
    print("NEE Response to Non-Flash Drought (SMs) - V11 Global (MemOpt)")
    print("=" * 70)
...
def save_chunks_to_netcdf(temp_files, output_file):
    ...
    global_attrs = {
        'title': 'NEE Response to Non-Flash SMs Drought - Global Analysis (v11, memopt)',
        'description': 'Memory-optimized non-flash SMs NEE response analysis with single-latitude reads, longitude batching, and streaming output.',
