...
FEATURE_LABELS = {
    ...
    "prepeak_VPD_resid": "VPD resid (prepeak)",
    "prepeak_total_evaporation_resid": "EVA resid (prepeak)",
    "prepeak_ssrd_resid_tmp": "SSRD resid|TMP (prepeak)",
    "prepeak_strd_resid_tmp": "STRD resid|TMP (prepeak)",
    "recoverywin_VPD_resid": "VPD resid (recoverywin)",
    "recoverywin_total_evaporation_resid": "EVA resid (recoverywin)",
    "recoverywin_ssrd_resid_tmp": "SSRD resid|TMP (recoverywin)",
    "recoverywin_strd_resid_tmp": "STRD resid|TMP (recoverywin)",
