...
SEM_GLEAM_DIR = PROCESS_DIR / "SEM_analysis0401" / "codex" / "GLEAM"
...
def get_target_specs() -> List[TargetSpec]:
    return [
        TargetSpec(
            ...
            "SMrz",
            PROCESS_DIR
            / "GPP-draught-analysis/code1/results/gpp_response_SMrz_events_global_v20260401_growingseason_recovery_gsdays_rel0_abspeak_absrec_c30x095_w420_decline30_d5_norecmax.nc",
        ),
        TargetSpec(
            "RECO",
            "code1",
            ...
            "SMrz",
            PROCESS_DIR
            / "RECO-draught-analysis/code1/results/reco_response_SMrz_events_global_v20260401_growingseason_recovery_gsdays_rel0_abspeak_absrec_c30x095_w420_decline30_d5_norecmax.nc",
        ),
    ]
