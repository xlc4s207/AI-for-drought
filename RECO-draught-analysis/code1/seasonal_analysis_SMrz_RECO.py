...
# -*- coding: utf-8 -*-
"""
骤旱RECO响应的季节性分析 (SMrz 根系层土壤湿度版)
Input: reco_response_events_global_v10.nc
"""
import numpy as np
import pandas as pd
...
NC_FILE = os.path.join(BASE_DIR, 'process/RECO-draught-analysis/results/reco_response_events_global_v10.nc')
OUTPUT_DIR = os.path.join(BASE_DIR, 'process/RECO-draught-analysis/results/seasonal_analysis')
...
def read_and_classify_events():
    ...
    try:
        ...
        # 如果是 RECO 文件，可能有些变量名不同，这里做最简单的处理
        raise
