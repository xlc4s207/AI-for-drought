...
# -*- coding: utf-8 -*-
"""
RECO Response Analysis - Non-Flash Drought (SMrz) V11 Global
=============================================================
分析根系土壤湿度 (SMrz) 非骤旱干旱事件对 RECO 的影响
...
OUTPUT_DIR = os.path.join(BASE_DIR, "process/RECO-draught-analysis/code3_nonflash_SMrz/result")
TEMP_DIR = os.path.join(OUTPUT_DIR, "temp_chunks_nonflash_SMrz_reco")
...
def main():
    print("=" * 70)
    print("RECO Response to Non-Flash Drought (SMrz) - V11 Global")
    print("=" * 70)
    ...
    # 保存 NetCDF
    print("\n保存最终结果...")
    out_file = os.path.join(OUTPUT_DIR, "reco_response_nonflash_SMrz_drought_v11_global.nc")
...
def save_to_netcdf(results, output_file):
    ...
    with nc.Dataset(output_file, 'w', format='NETCDF4') as ds:
        ...
        # 全局属性
        ds.title = 'GPP Response to Non-Flash SMrz Drought - RECO - Global Analysis (v11)'
