...
# -*- coding: utf-8 -*-
"""
将SMs骤旱RECO响应NC文件转换为空间分布TIF文件
数据源: reco_response_SMs_drought_v10_global_merged.nc
"""
import numpy as np
import pandas as pd
...
# ================= 配置 =================
NC_FILE = '/home/xulc/flash_drought/process/RECO-draught-analysis/code2_SMs/results/reco_response_SMs_drought_v10_global_merged.nc'
OUTPUT_DIR = '/home/xulc/flash_drought/process/RECO-draught-analysis/code2_SMs/results/spatial_tif'
