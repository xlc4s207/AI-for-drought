...
def main():
    print("=" * 70)
    print("RECO Response Analysis - SMs Flash Drought Events (V10 Global)")
    print("=" * 70)
...
def save_to_netcdf(results, lat_arr, lon_arr, output_file):
    ...
    with nc.Dataset(output_file, 'w', format='NETCDF4') as ds:
        ...
        # 全局属性
        ds.title = 'RECO Response to SMs Flash Drought Events - Global Analysis'
