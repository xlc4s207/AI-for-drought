...
RESULT_DIR = os.path.join(BASE_DIR, "result", "SMs_result_v5.3")
...
def parse_args():
    parser = argparse.ArgumentParser(description='全球干旱检测程序 v5.3 (5天窗口百分位数) - SMs')
...
def main():
    ...
    print("="*70)
    print("   全球干旱检测 v5.3 - 5天窗口百分位数优化版 (SMs 表层)")
    print("="*70)
