...
RESULT_ROOT="/home/xulc/flash_drought/process/SEM_analysis/codex/GLEAM/results/reco_code1_flash_smrz_mswepE_clean/sem_reco_precipEmean_candidates_20260416"
...
MODELS=(
  "M1_thermohydric_direct:reco_code1_flash_smrz_recoverywin_precipEmean_M1_thermohydric_direct_v20260416.txt"
  "M2_canopy:reco_code1_flash_smrz_recoverywin_precipEmean_M2_canopy_v20260416.txt"
...
echo "[DONE] RECO precipEmean candidate SEM comparison saved under $RESULT_ROOT"
