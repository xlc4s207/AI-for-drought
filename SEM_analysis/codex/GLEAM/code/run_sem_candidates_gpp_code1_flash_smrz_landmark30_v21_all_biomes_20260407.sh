...
run_biome_models() {
  ...
  case "$family" in
    forest)
      run_model "$biome" "M0_direct" "$SPEC_DIR/gpp_code1_flash_smrz_forest_landmark30_M0_direct_v21_20260407.txt"
      run_model "$biome" "M1_water" "$SPEC_DIR/gpp_code1_flash_smrz_forest_landmark30_M1_water_v21_20260407.txt"
      run_model "$biome" "M2_canopy" "$SPEC_DIR/gpp_code1_flash_smrz_forest_landmark30_M2_canopy_v21_20260407.txt"
      run_model "$biome" "M3_joint" "$SPEC_DIR/gpp_code1_flash_smrz_forest_landmark30_M3_joint_v21_20260407.txt"
      ;;
    nonwetland)
      run_model "$biome" "M0_direct" "$SPEC_DIR/gpp_code1_flash_smrz_nonwetland_landmark30_M0_direct_v21_20260407.txt"
      run_model "$biome" "M1_water" "$SPEC_DIR/gpp_code1_flash_smrz_nonwetland_landmark30_M1_water_v21_20260407.txt"
      run_model "$biome" "M2_canopy" "$SPEC_DIR/gpp_code1_flash_smrz_nonwetland_landmark30_M2_canopy_v21_20260407.txt"
      run_model "$biome" "M3_joint" "$SPEC_DIR/gpp_code1_flash_smrz_nonwetland_landmark30_M3_joint_v21_20260407.txt"
      ;;
    wetland)
      run_model "$biome" "M0_direct" "$SPEC_DIR/gpp_code1_flash_smrz_wetland_landmark30_M0_direct_v21_20260407.txt"
      run_model "$biome" "M1_water" "$SPEC_DIR/gpp_code1_flash_smrz_wetland_landmark30_M1_water_v21_20260407.txt"
      run_model "$biome" "M2_dualwater" "$SPEC_DIR/gpp_code1_flash_smrz_wetland_landmark30_M2_dualwater_v21_20260407.txt"
      run_model "$biome" "M3_hydroclimate" "$SPEC_DIR/gpp_code1_flash_smrz_wetland_landmark30_M3_hydroclimate_v21_20260407.txt"
      ;;
    *)
...
echo "[DONE] all biome landmark-30 v2.1 candidate models saved under $RESULT_ROOT"
