...
def parse_args():
    parser = argparse.ArgumentParser(description='全球骤旱检测程序(并行版)')
...
def main():
    ...
    print("="*60)
    print("   全球骤旱(Flash Drought)检测程序 - 多进程并行版")
    print("="*60)
    ...
    with nc.Dataset(nc_path, 'w', format='NETCDF4') as ds:
        ...
        ec.long_name = 'Total flash drought events per pixel (1980-2024)'
